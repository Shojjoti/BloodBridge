...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,900&display=swap"
        rel="stylesheet">
</head>
    ...
    <div class="auth-parent" style="justify-content: center;">
        <div class="auth-left">
            <div class="auth-box-center">
                ...
                <div class="auth-icon">
                    <img src="/BloodBridge/public/images/lock.png" alt="Reset Password" width="100%" height="100%">
                </div>
                ...
                <div class="field-block">
                    ...
                    <div class="field-input-wrap">
                        <input class="field-input" type="password" placeholder="Enter new password">
                ...
                <button class="common-btn">Reset Password</button>
